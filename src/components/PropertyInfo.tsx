  ...
  return (
    <section className="px-4 py-4 bg-card">
      <h1 className="text-heading font-extrabold text-foreground">
        {settings.property_title || "Sewa Apartemen Gresik – Unit Gunawangsa"}
      </h1>
      ...
      <p className="mt-3 text-body text-muted-foreground">
        {settings.property_description || "Sewa apartemen Gunawangsa Gresik langsung dari owner. Unit bersih, nyaman, dan aman untuk transit maupun menginap."}
      </p>
    </section>
  );
};
